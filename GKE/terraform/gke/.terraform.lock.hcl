...
provider "registry.terraform.io/hashicorp/google" {
  version     = "6.21.0"
  constraints = ">= 3.33.0, >= 3.43.0, >= 3.53.0, >= 3.83.0, >= 4.25.0, >= 4.51.0, >= 4.64.0, >= 5.31.0, >= 6.14.0, ~> 6.21.0, < 7.0.0"
  hashes = [
...
provider "registry.terraform.io/hashicorp/google-beta" {
  version     = "6.22.0"
  constraints = ">= 3.43.0, >= 4.64.0, >= 5.36.0, >= 6.13.0, >= 6.14.0, < 7.0.0"
  hashes = [
    "h1:NSfiUfq3f7ftL8VFKCTyiAnA4YQqj7bPgoTi9uJZEpA=",
